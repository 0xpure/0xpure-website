...
const ProjectList = {
  ...
  p2: [
    ...
    "?",
    pr2,
    "If you're on the site now, it's probably working",
    2,
  ],
  p3: [
    "PURESERVER (Minecraft)",
    "https://github.com/0xpure/pureserver-plugin-mine",
    pr3,
    "in develop",
    3,
  ],
  pr4: [
    "Telegram bot",
    "https://github.com/0xpure/tgpythonbot",
    pr4,
    "in develop",
    4,
  ],
  pr5: [
    "Palomaresbooks.ru",
    "https://github.com/0xpure/palomaresbooks/tree/master",
    pr5,
    "in develop",
    5,
  ],
